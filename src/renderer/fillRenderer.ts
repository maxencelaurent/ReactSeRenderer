...
export function solidFillDraw(fill: SolidFill, geometry: Geometry, feature: Feature, context: SeRenderingContext): void {
...
export function hatchFillDraw(fill: HatchedFill, geometry: Geometry, feature: Feature, context: SeRenderingContext): void {
   console.warn("HatchFill Not Yet Implemented");
}

export function drawFill(fill: Fill, geometry: Geometry, feature: Feature, context: SeRenderingContext): void {
